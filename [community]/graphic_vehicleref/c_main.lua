...
function setcpRLffectVehicle()
	...
	v.bumpIntensity = 0.25 -- intensity of the bump effect (vehicle)
...
function startCarPaintReflect()
		...
		shatterShader = dxCreateShader ( "fx/car_shatt.fx",1 ,v.renderDistance ,false, "vehicle" )		
		if paintShader and glassShader and shatterShader then
			...
			dxSetShaderValue ( paintShader, "bumpIntensity", v.bumpIntensity)
