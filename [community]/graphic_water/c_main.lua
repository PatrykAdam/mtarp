...
function enableWaterRef()
	...
	addEventHandler( "onClientHUDRender", root, waterRender, true, "high" .. orderPriority)
	addEventHandler( "onClientRender", root, waterRender2)
...
function disableWaterRef()
	...
	removeEventHandler( "onClientHUDRender", root, waterRender)
	removeEventHandler( "onClientRender", root, waterRender2)
end
